...
| G-052 | 2026-07-26 | **Dump-day intraday short (the retraction)** - vol≥3x + drop to short 09:45 | infra-invalid | PIT-clean at entry | "+50bps t5.1 confirmed, corrA -0.19" to hostility audit: signal used FULL-DAY volume (unknowable at 09:45, caused by the outcome). PIT version -15bps t-3.0. RETRACTED with entire downstream: pro-forma Sharpe 1.74 to 2.1, 3-way 25.5% CAGR, leverage k to 3.3-3.5 ALL INVALID | ~30 | dump_* scripts; propagated 4 turns before caught |
